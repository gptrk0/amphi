...
export const en = {
    ...
    libraryPage: {
        title: "Library",
        intro: "Everything the house has and everything on its way. A finished download seeds for a while before it can be deleted, and then goes on its own — with its files — once the retention time under Settings / Library is up.",
        ...
        retentionTooltip: "The retention time under Settings / Library. The files go with it.",
        marked: "marked",
        ...
        thisOne: "this",
        seedingNote: "This is still seeding for another {time}. It stays until then and goes by itself the moment the time is up.",
        deleteNote: "The torrent is removed from qBittorrent either way, and it will not be downloaded again. Do you want to keep the files on disk?",
        keepFiles: "Keep the files",
        deleteFiles: "Delete the files too",
        markedToast: "{name} will be deleted when its seed time is up.",
        stayingToast: "{name} is staying.",
        updateFailed: "Could not update {name}.",
        deletedToast: "{name} and its files were deleted.",
        removedKeptToast: "{name} was removed, the files were kept.",
