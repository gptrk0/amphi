...
export const hu: Messages = {
    ...
    libraryPage: {
        title: "Gyűjtemény",
        intro: "Minden, ami a háznak megvan, és minden, ami útban van. A befejezett letöltés egy ideig seedel, mielőtt törölhetővé válik, aztán magától elmegy — a fájljaival együtt —, amint lejár a Beállítások / Library alatti megőrzési idő.",
        ...
        retentionTooltip: "A Beállítások / Library alatti megőrzési idő. A fájlok is mennek vele.",
        marked: "megjelölve",
        ...
        thisOne: "ez",
        seedingNote: "Ez még {time} seedel. Addig marad, és magától elmegy, amint lejár az idő.",
        deleteNote: "A torrent mindkét esetben törlődik a qBittorrentből, és nem fog újra letöltődni. Megtartsuk a fájlokat a lemezen?",
        keepFiles: "Fájlok megtartása",
        deleteFiles: "A fájlokat is töröljük",
        markedToast: "{name} törlődik, amint lejár a seed-ideje.",
        stayingToast: "{name} marad.",
        updateFailed: "Nem sikerült frissíteni: {name}.",
        deletedToast: "{name} és a fájljai törölve.",
        removedKeptToast: "{name} eltávolítva, a fájlok megmaradtak.",
